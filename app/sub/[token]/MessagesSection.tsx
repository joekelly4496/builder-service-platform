...
export default function SubMessagesSection({
  requestId,
  subName,
  subEmail,
}: {
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6 mt-6">
      ...
      <div className="border-t border-slate-200 pt-4">
        <textarea
          ...
          rows={3}
          className="w-full px-4 py-3 border-2 border-slate-300 rounded-xl font-medium text-slate-900 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 resize-none"
        />
        <button
          onClick={handleSendMessage}
          disabled={sending || !newMessage.trim()}
          className="mt-3 w-full px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-all font-bold disabled:bg-slate-400"
        >
