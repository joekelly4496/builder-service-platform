...
export const builders = pgTable("builders", {
  ...
  slaUrgentAcknowledgeMinutes: integer("sla_urgent_acknowledge_minutes").default(1440),
  slaUrgentScheduleMinutes: integer("sla_urgent_schedule_minutes").default(2880),
